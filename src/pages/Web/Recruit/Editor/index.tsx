...
const Editor: React.FC<APIWebRecruit.Props> = (props) => {

  const [former] = Form.useForm<APIWebRecruit.Former>();
  const [loading, setLoading] = useState<APIWebRecruit.Loading>({});
  ...
  const onSubmit = (values: APIWebRecruit.Former) => {
    const params: APIWebRecruit.Editor = {
      name: values.name,
